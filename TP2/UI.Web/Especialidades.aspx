...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContentPlaceHolder" runat="server">
    ...
    <asp:Panel ID="formPanel" runat="server">
        ...
        <asp:RequiredFieldValidator ID="rfvDescripcionTxt" runat="server" ControlToValidate="descripcionTextBox" ErrorMessage="No puede dejar este campo vacío" ForeColor="Red"></asp:RequiredFieldValidator>
